...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2017 at 05:08 PM
...
CREATE TABLE `questionoption` (
  `OptionId` int(11) NOT NULL,
  `QuestionId` int(11) NOT NULL,
  `QuestionOptionTypeId` int(4) NOT NULL,
...
INSERT INTO `questionoption` (`OptionId`, `QuestionId`, `QuestionOptionTypeId`, `QuestionOption`, `Answer`, `weightage`, `OptionStatus`) VALUES
(55, 151, 3, 'A)Circle,B)Square', 'B)Square', '10.00', b'1'),
(64, 160, 3, 'A)Circle,B)square', 'A)Circle', '10.00', b'1'),
(65, 161, 3, 'A)Triangle,B)Rectangle', 'B)Rectangle', '10.00', b'1'),
(66, 162, 3, 'A)Triangle,B)square', 'A)Triangle', '10.00', b'1'),
(67, 163, 1, '', 'A)Circle', '10.00', b'0'),
(68, 164, 1, '', 'A)Circle', '10.00', b'0'),
(69, 165, 1, '', 'A)Circle', '10.00', b'0'),
(70, 166, 1, '', 'A)Circle', '10.00', b'0'),
(71, 167, 3, 'one.png,two.png', 'one.png', '10.00', b'1'),
(72, 168, 1, 'one.png,two.png,three.png,four.png', 'two.png', '10.00', b'1'),
(73, 169, 1, 'one.png,two.png,three.png,four.png', 'four.png', '10.00', b'1'),
(74, 170, 1, 'one.png,two.png,three.png,four.png', 'two.png', '10.00', b'1'),
(75, 171, 1, 'one.png,two.png,three.png,four.png', 'four.png', '10.00', b'1'),
(76, 172, 1, 'one.png,two.png,three.png,four.png', 'four.png', '10.00', b'1'),
(77, 173, 2, 'one.png,two.png,three.png', 'one.png', '10.00', b'1'),
(78, 174, 1, 'one.png,two.png,three.png,four.png', 'two.png', '10.00', b'1');
...
INSERT INTO `questions` (`QuestionId`, `Question`, `questionsHasImage`, `SubCategoryId`, `CategoryId`, `QusetionsLevelid`, `QuestionStatus`) VALUES
(151, 'What shape is this?', 'lkg/square1.png', 1, 1, 2, b'1'),
(160, 'What shape is this?', 'lkg/circle1.png', 1, 1, 2, b'1'),
(161, 'What shape is this?', 'lkg/rectangle1.png', 1, 1, 2, b'1'),
(162, 'What shape is this?', 'lkg/triangle1.png', 1, 1, 2, b'1'),
(163, 'Which shape is a circle?', 'lkg/triangle1.png,lkg/circle1.png', 2, 1, 2, b'0'),
(164, 'Which shape is a circle?', 'lkg/suare1.png,lkg/circle1.png', 2, 1, 2, b'0'),
(165, 'Which shape is a Suare?', 'lkg/suare1.png,lkg/circle1.png', 2, 1, 2, b'0'),
(166, 'Which shape is a triangle?', 'lkg/triangle1.png,lkg/circle1.png', 2, 1, 2, b'0'),
(167, 'Count the fish. Click each fish to keep track as you count.', 'lkg/fish.jpg', 1, 2, 2, b'1'),
(168, 'Count the snowflakes. Click each snowflake to keep track as you count.', 'lkg/snowflake1.png,lkg/snowflake2.png', 1, 2, 2, b'1'),
(169, 'Count the elephants. Click each elephant to keep track as you count.', 'lkg/elephant1.jpg,lkg/elephant2.jpg,lkg/elephant3.jpg,lkg/elephant4.jpg', 1, 2, 2, b'1'),
(170, 'Count the cows. Click each cow to keep track as you count.', 'lkg/cow1.jpg,lkg/cow2.jpg', 1, 2, 2, b'1'),
(171, 'How many butterflies are there?', 'lkg/butt1.png,lkg/butt2.png,lkg/butt3.png,lkg/butt4.png', 1, 3, 2, b'1'),
(172, 'How many starfish are there?', 'lkg/starfish1.png,lkg/starfish2.png,lkg/starfish3.png,lkg/starfish4.png', 1, 3, 2, b'1'),
(173, 'How many pandas are there?', 'lkg/panda.jpg', 1, 3, 2, b'1'),
(174, 'How many monkey are there?', 'lkg/monkey1.jpg,lkg/monkey1.jpg', 1, 3, 2, b'1');
...
(6, 151, 'lkg/img4.pn', 'Something about wrong answer and correct  answer with explanation', 'nil', 'nil', 'nil', 'nil');
...
--
ALTER TABLE `qusetionoptiontype`
  MODIFY `OptionTypeId` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `wronganswer`
  MODIFY `WrongAnswerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
